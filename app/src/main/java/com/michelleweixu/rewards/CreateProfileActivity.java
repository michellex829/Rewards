...
import com.michelleweixu.rewards.apis.CreateProfileAPIRunnable;
...
public class CreateProfileActivity extends AppCompatActivity {
    ...
    private static final String TAG = "Create Profile Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storyTitle.setText("Your story: (0 of 360)");
        setupEditText();
    ...
    public boolean onCreateOptionsMenu(Menu menu) { // standard for options menu
        getMenuInflater().inflate(R.menu.save_create_profile_menu, menu);
        return true;
    }

    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() ==  R.id.save_in_create) {
    ...
    public void CreateProfile(View v) {
        if (uname.getText().length() != 0 && pword.getText().length() != 0 &&
                ...
                sto.getText().length() != 0 && imageString64.length() != 0) {
            ...
            CreateProfileAPIRunnable createProfileRunnable = new CreateProfileAPIRunnable(this, firstName, lastName, username, department, story, position,
                    password, 1000, location, imageString64, apiKey);
            new Thread(createProfileRunnable).start();
        }
        else
            Toast.makeText(this, "Please fill all fields to proceed. \nMake sure to select a profile picture.", Toast.LENGTH_LONG).show();
    }
    ...
    public void onBackPressed() {
        ...
        if (username != null & ! username.isEmpty()) {
            ...
            Toast.makeText(this, "Profile is not saved! :( ", Toast.LENGTH_LONG).show();
            setResult(RESULT_CANCELED, intent);
            finish();
        }
    }

    public void requestFailDialog(String message) {
        ...
        builder.setMessage("Oops, profile was NOT created." +
    ...
    protected void onSaveInstanceState(Bundle outState) {
        outState.putString("username", uname.getText().toString());
    ...
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        uname.setText(savedInstanceState.getString("username"));
